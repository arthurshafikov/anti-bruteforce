...
func (m *MockHandler) InitRoutes(engine *gin.Engine) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "InitRoutes", engine)
}

// InitRoutes indicates an expected call of InitRoutes.
func (mr *MockHandlerMockRecorder) InitRoutes(engine interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitRoutes", reflect.TypeOf((*MockHandler)(nil).InitRoutes), engine)
}
